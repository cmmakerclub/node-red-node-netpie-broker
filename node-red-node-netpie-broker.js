...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("netpie-mqtt-broker",MQTTBrokerNode,{
        credentials: {
            user: {type:"text"},
    ...
    RED.nodes.registerType("netpie mqtt in",NETPIEMQTTInNode);

    function NETPIEMQTTOutNode(n) {
        RED.nodes.createNode(this,n);
        this.topic = n.topic;
        this.qos = n.qos || null;
    ...
    RED.nodes.registerType("netpie mqtt out",NETPIEMQTTOutNode);
};
